...
public abstract class DataParser
{
    ...
    abstract public String extractName ();

    abstract public String extractMainImage ();

    abstract public double extractPrice ();

    abstract public List<Review> extractReviews ();

    abstract public List<String> extractAlternateImages ();
    ...
    public List<String> getAlternateImages ()
    {
        if (alternateImages == null)
            alternateImages = extractAlternateImages();
